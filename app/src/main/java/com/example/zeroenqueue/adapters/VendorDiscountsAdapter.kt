...
class VendorDiscountsAdapter(var context: Context,
...
override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VendorDiscountsAdapter.DiscountsViewHolder {
