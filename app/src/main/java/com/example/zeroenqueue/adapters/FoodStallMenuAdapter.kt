...
class FoodStallMenuAdapter (
    var context: Context,
    val foodList: List<Food>
) : RecyclerView.Adapter<FoodStallMenuAdapter.FoodStallMenuViewHolder>() {

    inner class FoodStallMenuViewHolder(val view: View) : RecyclerView.ViewHolder(view),
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FoodStallMenuAdapter.FoodStallMenuViewHolder {
        return FoodStallMenuViewHolder(
    ...
    override fun onBindViewHolder(
        holder: FoodStallMenuAdapter.FoodStallMenuViewHolder,
        position: Int
    ) {
    ...
    fun getFoodStallMenu(): List<Food> {
        return foodList
    }
}